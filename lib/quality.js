...
function assessShop(shop, ctx) {
  ...
  if (!isEmpty(shop.social_facebook) && !extractFacebookPage(shop.social_facebook)) {
    add('BAD_SOCIAL', 'suspect', `social_facebook is not a real Page: ${String(shop.social_facebook).slice(0, 60)}`, 'deep_scrape');
  }
